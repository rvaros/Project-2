...
xText
  .append("text")
  .attr("y", 0)
  .attr("data-name", "current income")
  .attr("data-axis", "x")
  .attr("class", "aText inactive x")
  .text("Current Median Household Income");
...
yText
  .append("text")
  .attr("x", 0)
  .attr("data-name", "current sqFtPr")
  .attr("data-axis", "y")
  .attr("class", "aText inactive y")
  .text("Current Housing Price per Square Foot");

var url='https://raw.githubusercontent.com/rvaros/U.S.-Housing-Affordability-and-Foreclosure-Percentage-Project/master/templates/Affordability%20Data/index/assets/data/stateAbbr.json'
...
function visualize(theData) {
  ...
  var toolTip = d3
    ...
    .html(function(d) {
      ...
      var theX;
      // Grab the state name.
      var theState = "<div>" + d.State_Name + "</div>";
